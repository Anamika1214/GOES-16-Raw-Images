...
def processing(pathData, pathScripts):
    ...
    plt.savefig(pathScripts + '/Output/Band12/INPE_G16_CH' + str(Band) + '_' + Start + '.png', dpi=DPI, bbox_inches='tight', pad_inches=0)

# Path to the GOES-R simulated image file
path = '/GEONETCast/Band12/'
pathScripts = "/Scripts/GEONETCast"

# Create output folder if it does not exist
# "Band01, Band02, ..."
try:
    os.mkdir(pathScripts + "/Output/Band12/")
