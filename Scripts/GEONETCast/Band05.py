...
def processing(path):
    ...
    oot direcotry with "Data", "Output" and "Scripts" folders
    path: path to NetCDF file to be manipulated
...
path = '/GEONETCast/Band05/'

# Create output folder if it does not exist
# "Band01, Band02, ..."
try:
    os.mkdir("/Scripts/GEONETCast/Output/Band05/")
