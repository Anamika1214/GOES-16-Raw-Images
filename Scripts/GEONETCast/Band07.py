...
def processing(pathData, pathScripts):
    ...
    cpt = loadCPT(pathScripts + '/Colortables/SVGAIR2_TEMP.cpt')
    ...
    # Save the result
    # print(pathScripts + '/GEONETCast/Output/' + path[12:18] + '/INPE_G16_CH' + str(Band) + '_' + Start + '.png')
    plt.savefig(pathScripts + '/Output/Band07/INPE_G16_CH' + str(Band) + '_' + Start + '.png', dpi=DPI, bbox_inches='tight', pad_inches=0)

# Path to the GOES-R simulated image file
path = '/GEONETCast/Band07/'
pathScripts = "/Scripts/GEONETCast"

# Create output folder if it does not exist
# "Band01, Band02, ..."
try:
    os.mkdir(pathScripts + "/Output/Band07/")
