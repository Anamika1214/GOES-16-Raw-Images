...
def processing(pathData, pathScripts):
    ...
    bmap.readshapefile(pathScripts + '/Shapefiles/ne_10m_admin_0_countries','ne_10m_admin_0_countries',linewidth=0.50,
        color='cyan')
    ...
    # Save the result
    # print(pathScripts + '/Output/' + path[12:18] + '/INPE_G16_CH' + str(Band) + '_' + Start + '.png')
    plt.savefig(pathScripts + '/Output/Band04/INPE_G16_CH' + str(Band) + '_' + Start + '.png', dpi=DPI, bbox_inches='tight', pad_inches=0)

# Path to the GOES-R simulated image file
path = '/GEONETCast/Band04/'
pathScripts = "/Scripts/GEONETCast"

# Create output folder if it does not exist
# "Band01, Band02, ..."
try:
    os.mkdir(pathScripts + "/Output/Band04/")
